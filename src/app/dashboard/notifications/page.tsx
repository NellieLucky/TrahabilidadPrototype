  ...
  const [notifications, setNotifications] = useState<NotificationItem[]>([
    {
      ...
      message: 'Vibe Wellness Spa Manila posted a new listing "Licensed Massage Therapist (Masahista)" matching your Low Vision & Blind accessibility profile.',
      time: '1 hour ago',
      type: 'success',
      read: false,
    },
    {
      ...
      message: 'Google Philippines has confirmed a Screen Reader Compatible test environment and extended Response Time will be provided for your upcoming Transcriptionist & Virtual Assistant interview.',
      time: '3 hours ago',
      type: 'success',
      read: false,
    },
    ...
    },
    {
      ...
      message: 'Virtualahan has viewed your profile and downloaded your resume for the Virtual Assistant role.',
      time: '2 days ago',
      type: 'info',
      read: true,
    },
