  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-5 pt-2">
        ...
        <div>
          <fieldset>
            <legend className="text-base font-bold text-foreground-color mb-2">
            ...
            <div className="space-y-2 max-h-[220px] overflow-y-auto border border-border-color rounded-lg p-3 bg-surface">
                  ...
                  <Checkbox
                    ...
                    label={
                      <span className="flex items-center justify-between w-full">
                        <span>{opt.label}</span>
                        <span className="text-[10px] font-bold text-gray-400 uppercase ml-2 bg-white dark:bg-[#1a1a1a] px-1.5 py-0.5 rounded border border-border-color">
                          {opt.category}
                        </span>
                      </span>
                    }
        ...
        <div className="flex justify-end gap-3 pt-3 border-t border-border-color">
          ...
          <Button variant="primary" type="submit" disabled={submitting}>
            {submitting ? 'Submitting...' : 'Submit Accessible Application'}
          </Button>
        </div>
      </form>
    </Dialog>
